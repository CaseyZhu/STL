...
-->
This checklist is for [Hardware Stage]({{< relref "/doc/project/development_stages.md" >}}) transitions for the [DMA peripheral.]({{< relref "." >}})
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Not Started | [DMA Design Spec]({{<relref "." >}})
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | [DMA DV document]({{<relref "dv" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [DMA Testplan]({{<relref "dv/index.md#testplan" >}})
